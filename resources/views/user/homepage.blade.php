        ...
        <div class="container mt-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="row">
                    <div class="col-6">
                        <a href="/user/profil">
                            <img style="width: 5   0px; height: 40px;" src="{{URL::asset('/img/profil2.webp')}}" alt="">
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="/user/logout" style="width: 60%;">Logout</a>
                    </div>
            ...
            <div class="row">
                <div class="col-4 mb-4">
                    <div class="card p-2" style="width: 22rem;">
                        ...
                        <div class="card-harga" data-bs-toggle="modal" data-bs-target="#promo">
                            <span>
                                <h4>IDR 167.900</h4>
                                <p>include tax</p>
                            </span>
     ...
     <div class="modal fade" id="promo" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">Concert Ticket Reservations</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="form-label">Full Name</label>
                    <input type="text" class="form-control mb-1" value="Kyle jenner">
                </div>
                <div class="form-group">
                    <label class="form-label">Phone Number</label>
                    <input type="text" class="form-control mb-1" value="087xxxxxxxx">
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal">Order</button>
            </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-1" value="Rp 80000">
                </div>
                <div class="form-group">
                    <label class="form-label">Price</label>
                    <select class="custom-select">
                ...
                <div class="col-md-6">
                    <div class="card-kontak w-100">
                        <form action="/user/contact" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="pertanyaan" id="floatingInput">
